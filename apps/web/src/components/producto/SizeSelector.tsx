                ...
                {sizes.map((size) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {stock > 0 && (
                                <span className={cn(
                                    "mt-1 px-2.5 py-1 rounded-full text-[10px] font-black uppercase tracking-tight shadow-sm",
                                    stock < 5 ? "bg-orange-100 text-orange-600" : "bg-emerald-100 text-emerald-600"
                                )}>
                                    {stock} DISPONIBLES
                                </span>
                            )}
